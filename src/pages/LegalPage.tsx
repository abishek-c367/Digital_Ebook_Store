...
const content = {
  privacy: {
    ...
    sections: [
      ...
      { heading: 'How We Use Your Data', body: 'Your email is used to verify purchases, generate secure reading links, and provide access to your purchased books. Payment processing is handled by Razorpay — we do not store your card or bank details.' },
