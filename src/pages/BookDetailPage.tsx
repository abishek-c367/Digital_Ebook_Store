...
import { fetchBookBySlug, formatPrice, formatDate } from '@/lib/books';
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="flex flex-col animate-fade-in-up">
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <span className="font-serif text-3xl text-ink-900">{formatPrice(book.price_cents, book.currency)}</span>
                {user ? (
      ...
      {!user && (
        <section className="bg-ink-900 py-16">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <p className="mt-3 font-serif text-lg text-ink-300">Create a free account to read this book instantly.</p>
